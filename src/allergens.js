...
// Optimizations for smaller screens    
  ...
  window.addEventListener("resize", () => {
    ...
    if (window.innerWidth <= 680) {
      document.body.style.gridTemplateRows = "100vh 180em 20vh";
    }
...
// Creating the list by iterating through the array of allergens
  ...
  firstAdvicePara.textContent =
    "If you suffer from allergies to these or any products, please get in touch with us before ordering. We can not be held responsible for any negligence due on your part.";
  ...
  secondAdvicePara.textContent =
    "For more information regarding allergen advice please consult the Food Standards Agency Website.";
